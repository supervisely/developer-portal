...
2. [Modal window](app-json-config.md#undefined)
3. Single page app
...
Modal Window is designed to have all app pre-launch configuration options in a centralized dialog within one tab.
