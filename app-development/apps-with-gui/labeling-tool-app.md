...
[**Step 10.**](labeling-tool-app.md#step-10.-optimizations-optional) Optimizations (optional).\
...
To use the advanced debug mode, you'll need to prepare two .env files. Learn more about them [here](labeling-tool-app.md).
