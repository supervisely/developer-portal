...
- [Supervisely annotation format](getting-started/supervisely-annotation-format/README.md)
  ...
  - [Audio Annotation](getting-started/supervisely-annotation-format/audio.md)
- [Python SDK tutorials](getting-started/python-sdk-tutorials/README.md)
  ...
  - [Audio](getting-started/python-sdk-tutorials/audio/README.md)
    - [Audio](getting-started/python-sdk-tutorials/audio/audio.md)
