...
- [Command Line Interface (CLI)](getting-started/command-line-interface/README.md)
  ...
  - [Supervisely SDK CLI](getting-started/command-line-interface/sdk-cli.md)
...
- [Custom 3D AI Assistant app](app-development/create-3d-assistant-app/create-3d-assistant.md)
  - [Overview](app-development/create-3d-assistant-app/create-3d-assistant.md#1-overview)
  - [Set up environment for development](app-development/create-3d-assistant-app/create-3d-assistant.md#2-set-up-environment-for-development)
  - [Create code base](app-development/create-3d-assistant-app/create-3d-assistant.md#3-create-code-base)
  - [Advanced debug](app-development/create-3d-assistant-app/create-3d-assistant.md#4-advanced-debug)
  - [App configuration](app-development/create-3d-assistant-app/create-3d-assistant.md#5-app-configuration)
  - [App release](app-development/create-3d-assistant-app/create-3d-assistant.md#6-app-release)
- [Neural Network integration](app-development/neural-network-integration/README.md)
  ...
  - [Serving App](app-development/neural-network-integration/inference/README.md)
    ...
    - [Image matting](app-development/neural-network-integration/inference/image-matting.md)
    - [How to customize model inference](app-development/neural-network-integration/inference/customize-inference.md)
    - [Example: Custom model inference with probability maps](app-development/neural-network-integration/inference-with-gui/custom-inference-with-alpha-mask-segmentation.md)
...
- [Automate with Python SDK & API](advanced-user-guide/automate-with-python-sdk-and-api/README.md)
  ...
  - [Webhooks](advanced-user-guide/automate-with-python-sdk-and-api/webhooks.md)
  - [Training API](advanced-user-guide/automate-with-python-sdk-and-api/training-api.md)
